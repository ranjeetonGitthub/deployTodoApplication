...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/old-flower-b22f#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-flower-b22f
```

A live public deployment of this template is available at [https://old-flower-b22f.templates.workers.dev](https://old-flower-b22f.templates.workers.dev)
